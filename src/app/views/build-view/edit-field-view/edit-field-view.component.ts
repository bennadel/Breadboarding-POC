...
@Component({
	selector: "poc-edit-field-view",
	host: {
		"(window:keydown.escape)": "handleEscape()"
	},
	styleUrls: [
		"./edit-field-view.component.less",
	...
	templateUrl: "./edit-field-view.component.html"
})
export class EditFieldViewComponent {
	...
	public processDelete() : void {
		...
		this.breadboardService
			.fieldItemDeleteByID( this.itemID )
			.then(
				() => {
