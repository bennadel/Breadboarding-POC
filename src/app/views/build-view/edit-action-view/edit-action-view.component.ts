...
@Component({
	selector: "poc-edit-action-view",
	host: {
		"(window:keydown.escape)": "handleEscape()"
	},
	styleUrls: [
		"./edit-action-view.component.less",
	...
	templateUrl: "./edit-action-view.component.html"
})
export class EditActionViewComponent {
	...
	public processDelete() : void {
		...
		this.breadboardService
			.actionItemDeleteByID( this.itemID )
			.then(
				() => {
	...
	public processForm() : void {
		...
		promise.then(
			( targetBreadboardID ) => {
				...
				var itemPromise = this.breadboardService.actionItemUpdateByID(
					this.itemID,
					{
